...
export const AuthSidePanel = () => {
  return (
    <aside className="relative hidden h-full overflow-hidden bg-[#020b18] px-8 py-5 text-white lg:block xl:px-12">
      <img
      ...
      <div className="relative z-10 flex h-full flex-col">
        <div className="pt-3 text-center xl:pt-5">
          <div className="inline-flex items-center gap-4">
            <Box className="h-12 w-12 text-blue-500 xl:h-14 xl:w-14" strokeWidth={2.6} />
        ...
        <div className="mt-auto grid grid-cols-4 pb-2 pt-5">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={benefit.title}
                className={`px-3 text-center ${index > 0 ? 'border-l border-blue-200/15' : ''}`}
              >
                <Icon className="mx-auto mb-2 h-8 w-8 text-blue-500 xl:h-9 xl:w-9" strokeWidth={2.35} />
